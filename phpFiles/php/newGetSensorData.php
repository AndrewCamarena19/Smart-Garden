...
$query = "SELECT readings.temp, readings.humidity, readings.moisture, readings.timeStamp
...
WHERE readings.sensorName = '$gSensor' AND logintable.userName = '$gUser' AND gardentbl.gardenName = '$gName' AND readings.timeStamp >= '$gMin 00:00:00' AND readings.timeStamp <= '$gMax 23:59:59' ORDER BY timestamp asc;";
//echo $query;
// call the SQL query
